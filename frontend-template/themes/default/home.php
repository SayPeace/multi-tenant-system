    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div style="margin-top: 20px;">
                <a href="/issue/<?= $currentIssue['issue']->id ?>" class="btn btn-primary">View Full Issue</a>
            </div>
            <?php else: ?>
    ...
    <aside class="sidebar">
        ...
        <div class="card">
            ...
            <div class="announcement">
                ...
                <small style="color: #666;"><?= date('M j, Y', strtotime($announcement->published_at)) ?></small>
            </div>
            <?php endforeach; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="card">
            ...
            <?php endif; ?>
            <p style="margin-top: 10px;"><a href="/about">Read more &rarr;</a></p>
        </div>
    </aside>
</div>
